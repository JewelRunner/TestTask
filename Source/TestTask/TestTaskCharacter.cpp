...
void ATestTaskCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATestTaskCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATestTaskCharacter::Look);
	}
	else
	{
...
void ATestTaskCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestTaskCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
